...
## 活かせる経験・知識・技術
### データ整備ノウハウ
- 直近では広告代理店様にて分析用のデータ基盤管理を行っております。ETL、データベース管理、分析用クエリの開発が主な業務となります。特に時系列の観点からの集計、分析を得意としています。システム環境はMicrosoft Azure 環境を使う機会が多いです。属人的にならないように、作業ログの作成やドキュメントの整備に適切な工数を使い整備しながら作業を進めてまいります。
...
#### IAサーバの導入/小規模案件（2004年07月～2004年12月）
- 概要
